...
economy = {
	...
	MAX_LOAN_CAP_FROM_BANKS = 50, --3, -- can loan max % of country tax base from single country
	...
	MAX_FACTORY_MONEY_SAVE = 10000,	-- 1000 how much money is stored maximum in a factory.
...
military = {
	...
	SOLDIER_TO_POP_DAMAGE = 0.6,
	LAND_SPEED_MODIFIER = 1,
	NAVAL_SPEED_MODIFIER = 2,
	EXP_GAIN_DIV = 0.01, --0.05,
...
diplomacy = {
	...
	MAX_WARSCORE_FROM_BATTLES = 33, --50,
	
	GUNBOAT_DIPLOMATIC_COST = 1,
	GUNBOAT_RELATION_ON_ACCEPT = 1,
	WARGOAL_JINGOISM_REQUIREMENT = 0.05, --0.07,
	...
	INVESTMENT_INFLUENCE_DEFENSE = 0.1, -- 0.5,	-- maximum defense factor in sphere of having invested in a country
	...
	LARGE_POPULATION_INFLUENCE_PENALTY = -0.001, -- -0.4,
...
pops = {
	...
	SLAVE_GROWTH_DIVISOR = 2, --10 Slaves have N times lower growth
